...
- [ ] Mehdi : coller `Code.gs` **v5** et redéployer (Nouvelle version), passer le raccourci à 5 actions (README §6), puis automatisation Heure de la journée (23:50, « Exécuter immédiatement ») + « Toujours autoriser » au dialogue d'envoi.
